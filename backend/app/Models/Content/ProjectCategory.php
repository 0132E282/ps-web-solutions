...
class ProjectCategory extends BaseTerm
{
  ...
  public function configs(): array
  {
    return [
      ...
      'meta.image' => ['ui' => 'image', 'config' => ['validation' => 'nullable|image|max:2048', 'placeholder' => 'e.g. electronics.jpg']],
      ...
      'parent' => ['ui' => 'select', 'config' => ['collection' => ProjectCategory::class, 'validation' => 'nullable|exists:taxonomies,id']],
    ];
  }
