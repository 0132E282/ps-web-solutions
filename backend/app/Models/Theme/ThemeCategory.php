...
class ThemeCategory extends BaseTerm
{
  public function configs(): array
  {
    return [
      ...
      'slug' => ['ui' => 'text', 'config' => ['validation' => 'nullable|max:255|unique:taxonomies,slug,' . ($this->id ?? 'NULL') . ',id', 'placeholder' => 'e.g. electronics']],
      ...
      'parent' => ['ui' => 'select', 'config' => ['collection' => 'theme_categories', 'validation' => 'nullable|exists:taxonomies,id', 'query' => ['id' => ['_neq' => '$this->id']]]],
    ];
  }
