...
class ProductOption extends BaseTerm
{
    ...
    public function configs(): array
    {
        return [
            ...
            'property.type' => ['type' => 'button-radio', 'config' => ['layout' => 'horizontal', 'label' => 'Option Type', 'options' => [['label' => 'Select', 'value' => 'select'], ['label' => 'Radio', 'value' => 'radio'], ['label' => 'Checkbox', 'value' => 'checkbox']], 'validation' => 'required|in:select,radio,checkbox']],
