...
class Admin extends User
{
    ...
    public $configs = [
        ...
        'status' => ['type' => 'button-radio', 'config' => ['layout' => 'horizontal', 'options' => [['label' => 'Active', 'value' => 'active'], ['label' => 'Inactive', 'value' => 'inactive']], 'validation' => 'required|in:active,inactive']],
