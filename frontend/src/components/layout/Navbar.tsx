  ...
  <nav className="h-20 border-b border-slate-200/60 flex items-center bg-white/80 backdrop-blur-md sticky top-0 z-50">
    <div className="container mx-auto px-5 flex items-center justify-between gap-8 h-full">
      ...
      <Link href="/" className="flex items-center gap-3 group cursor-pointer shrink-0">
        <div className="w-10 h-10 bg-linear-to-br from-brand-dark to-slate-700 text-white flex items-center justify-center rounded-xl text-xl font-black transition-transform duration-300 group-hover:scale-110 shadow-lg shadow-slate-200">
           M
        </div>
        <div className="flex flex-col">
            <span className="text-xl font-bold text-brand-dark leading-tight tracking-tight">My<span className="bg-linear-to-r from-brand-primary to-orange-400 bg-clip-text text-transparent">Website</span></span>
      ...
      <div className="flex items-center gap-3 lg:gap-8">
        <div className="hidden xl:flex items-center gap-7 text-sm font-bold text-slate-600">
          <Link href="/" className="hover:text-brand-primary transition-all relative group py-2">
            Thiết kế Website
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-brand-primary transition-all group-hover:w-full"></span>
          </Link>
          <Link href="/domain" className="hover:text-brand-primary transition-all relative group py-2">
            Domain
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-brand-primary transition-all group-hover:w-full"></span>
          </Link>
        </div>
